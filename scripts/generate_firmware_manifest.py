...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Generate a signed firmware manifest for drone_swarm phase 4"
    )
    ...
    parser.add_argument(
        "--secret",
        required=True,
        help="shared signing secret used by DRONE_FIRMWARE_SIGNING_SECRET",
    )
    ...
    print(
        "  DRONE_FIRMWARE_SIGNING_SECRET=<set this locally to the secret used for signing>"
    )
    return 0
