...
PYBIND11_MODULE(drone_bridge, m) {
    ...
    py::class_<vio::RuntimeTelemetry>(m, "RuntimeTelemetry")
        ...
        .def_readwrite("edge_average_packet_size_bytes", &vio::RuntimeTelemetry::edge_average_packet_size_bytes)
        .def_readwrite("edge_bandwidth_savings_estimate_pct", &vio::RuntimeTelemetry::edge_bandwidth_savings_estimate_pct)
        .def_readwrite("edge_packet_encode_latency_us", &vio::RuntimeTelemetry::edge_packet_encode_latency_us)
        ...
        .def_readwrite("edge_inference_confidence", &vio::RuntimeTelemetry::edge_inference_confidence)
