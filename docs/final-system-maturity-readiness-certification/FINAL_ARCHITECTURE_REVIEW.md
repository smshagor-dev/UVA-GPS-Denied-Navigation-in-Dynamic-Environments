...
- `research/`
- `experiments/`
- `docs/research-validation-software-hil-scenarios/` through `docs/scientific-publication-artifact-evaluation/`
...
- `docs/enterprise-deployment-security-readiness/MONITORING_REPORT.md`
...
- `docs/enterprise-deployment-security-readiness/SECURITY_AUDIT.md`
