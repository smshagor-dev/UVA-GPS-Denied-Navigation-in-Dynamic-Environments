...
- Phase 6 performance suite: `docs/performance-engineering-stability-validation/performance_results.json`
- Phase 6 benchmark report: `docs/performance-engineering-stability-validation/BENCHMARK_REPORT.md`
- Phase 7 regression evidence: `docs/research-validation-software-hil-scenarios/performance_regression_final.json`
- Phase 8 benchmark comparison package: `docs/open-research-release-advanced-scenarios/FINAL_BENCHMARK_REPORT.md`
