...
| `ctest --test-dir build-phase1-clean -C Release --output-junit docs/foundation-repository-hygiene/ctest-results.xml` | PASS | JUnit written under `build-phase1-clean/docs/foundation-repository-hygiene/ctest-results.xml` |
...
- Not run: `0`
- Duration: `5.95 sec`
- JUnit artifact: `build-phase1-clean/docs/foundation-repository-hygiene/ctest-results.xml`
