...
Primary artifact: `docs/performance-engineering-stability-validation/soak_results.json`
...
- `docs/performance-engineering-stability-validation/soak_results.json` has not yet been replaced by an `8 h` completion artifact
