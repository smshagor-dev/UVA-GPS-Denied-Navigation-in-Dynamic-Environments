...
- `docs/performance-engineering-stability-validation/controlplane_cpu.pprof`
- `docs/performance-engineering-stability-validation/controlplane_cpu_top.txt`
- `docs/performance-engineering-stability-validation/callgrind_navigation.out`
- `docs/performance-engineering-stability-validation/callgrind_navigation.txt`
- `docs/performance-engineering-stability-validation/callgrind_ekf.out`
- `docs/performance-engineering-stability-validation/callgrind_ekf.txt`
- `docs/performance-engineering-stability-validation/perf_report.txt`
...
Source: `docs/performance-engineering-stability-validation/controlplane_cpu_top.txt`
...
Source: `callgrind_annotate --tree=calling --threshold=5 docs/performance-engineering-stability-validation/callgrind_ekf.out`
...
Source: `docs/performance-engineering-stability-validation/callgrind_ekf.txt`
...
Source: `docs/performance-engineering-stability-validation/callgrind_navigation.txt`
...
From `docs/performance-engineering-stability-validation/soak_results.json`:
...
- see `docs/performance-engineering-stability-validation/perf_report.txt`
