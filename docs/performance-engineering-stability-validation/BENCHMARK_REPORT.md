...
Primary artifact: `docs/performance-engineering-stability-validation/benchmark_results.json`
...
Comparison source: `docs/architecture-safety-validation-hardening/benchmark_results.json`
