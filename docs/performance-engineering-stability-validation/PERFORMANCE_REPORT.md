...
- `docs/performance-engineering-stability-validation/tsan_ctest_phase65.log` contains repeated ThreadSanitizer warnings
- `docs/performance-engineering-stability-validation/TSAN_ROOT_CAUSE_ANALYSIS.md` traces those warnings to `libOpenNI2.so.0`
