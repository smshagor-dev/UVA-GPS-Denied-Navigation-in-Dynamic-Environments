...
- `docs/phase4/parser_benchmark.log`
- `docs/phase4/config_audit.json`
...
For the edge-protocol config path, a like-for-like scalar extraction microbenchmark at `docs/phase4/parser_benchmark.log` showed:
